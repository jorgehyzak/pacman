var service_host = 'ec2-18-117-241-11.us-east-2.compute.amazonaws.com'
var auth_details = ''
...
var database = {
    ...
    options: {
        ...
        connectTimeoutMS: 1000,  // 1 second timeout for connection
        socketTimeoutMS: 1000    // 1 second timeout for socket (optional)
    }
};
